          ...
          <Form>
            ...
            <Row>
              <Form.Group className="mb-3 col-lg-3">
                ...
                <InputGroup style={{marginLeft: -10, width: 280}} className="mb-3">
                  <Form.Control
              ...
              <Form.Group style={{ marginLeft: 60, width: 290 }} className="mb-3 col-lg-3">
              ...
              <Form.Group style={{ marginLeft: 45, width: 290 }} className="mb-3 col-lg-3">
            ...
            <br/>
            <Row>
              <Form.Group style={{ width: 300}} className="mb-3 col-lg-3">
                <Form.Label>Giá ưu đãi trên thị trường</Form.Label>
                <InputGroup style={{marginLeft: -10}} className="mb-3">
                  <Form.Control
                    className="border-dark rounded-start-pill"
                    size="lg"
                    aria-label="giaUDTTT"
